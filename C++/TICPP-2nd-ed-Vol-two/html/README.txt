README-HTML.txt file for Thinking in C++, 2nd Edition, Volume 2 
by Bruce Eckel and Chuck Allison. Copyright (c)2001 www.MindView.net.

This set of HTML files is designed to work with most web browsers. 
You will find here the entire book, "Thinking in C++, 2nd Edition, Volume 2"
in its current state. SOME OF THE BOOK IS IN VERY EARLY FORM.

The expected publication date is July 2002. If you put yourself on the mailing 
list at http://www.BruceEckel.com you'll be informed of updates and publication 
information.
...
-- To start using the frames version, open:
    ...
    >> "FramCont.htm" for the full table of contents
